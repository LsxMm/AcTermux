...
public String outPut = "";
    ...
    public void handleMessage(Message msg) {
      if (msg.what == MSG_NEW_INPUT && isRunning()) {
        ...
        if (bytesRead > 0) {
          ...
          outPut = new String(mReceiveBuffer, StandardCharsets.UTF_8);
          notifyScreenUpdate();
        }
  ...
  public TerminalSession(Context context,String shellPath, String cwd, String[] args, String[] env, SessionChangedCallback changeCallback) {
      ...
      public void run() {
        ...
        try (InputStream termIn = new FileInputStream(terminalFileDescriptorWrapped)) {
          while (true) {
            ...
            outPut = new String(buffer, StandardCharsets.UTF_8);
          }
